...
<div class="w3-content" style="max-width:4000px;margin-top:46px">
  ...
  <!--
    <img src="cosmos.jpeg" style="width:100%">
  ...
  <div class="mySlides w3-display-container w3-center">
    <img src="cosmos2.jpeg" style="width:100%">
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
      <h3>New York</h3>
...
<!--            <button class="w3-button w3-black w3-margin-bottom" onclick="window.location.href = 'https://ide.geeksforgeeks.org';">Cool Video</button> -->
          </div>
        </div>
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px" id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        <i class="fa fa-map-marker" style="width:30px"></i> Hamburg, DE<br>
        <i class="fa fa-envelope" style="width:30px"> </i> rubirah1 at gmail<br>
      </div>
      <div class="w3-col m6">
